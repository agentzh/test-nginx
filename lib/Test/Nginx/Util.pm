...
our $Http3SSLCrtKey = $ENV{TEST_NGINX_HTTP3_CRT_KEY};
...
if ($UseHttp3 && (!defined $Http3SSLCrt || !defined $Http3SSLCrtKey)) {
    die "Must set both env TEST_NGINX_HTTP3_CRT and TEST_NGINX_HTTP3_CRT_KEY in global HTTP/3 test mode\n";
}
...
sub use_http2 ($) {
    ...
    if ($UseHttp2) {
        ...
        if (defined $block->http3) {
            ...
            $block->set_value("test_nginx_enabled_http0", 0);
            return undef;
        }
